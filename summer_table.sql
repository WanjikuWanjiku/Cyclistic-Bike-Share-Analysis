...
where start_station_id = '13221' and start_station_name = ''
;

-- Delete the entries with blank end_lat and end_lng 
DELETE from summer_table
...
-- ACCURACY
-- Confirm that values in the summer table fall between June, July, August 2021
-- Between 1st June 2021 and 1st September 2021
select *
from summer_table
where started_at not between '2021-06-01' and '2021-11-01'
;
...
DELETE FROM summer_table
where start_station_id in ('LF-005', '13300', 'TA1307000041', 'TA1309000039', 'TA1309000049', '13099','TA1306000029','351') 
	or end_station_id in ('LF-005', '13300', 'TA1307000041', 'TA1309000039', 'TA1309000049', '13099','TA1306000029','351') 
;
