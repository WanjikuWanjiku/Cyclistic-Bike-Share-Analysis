...
-- Total number of rides based on membership in summer
SELECT member_casual, count(*) as number_of_rides
FROM summer_table
GROUP BY member_casual
;

-- Total number of rides based on rideable type in summer
SELECT rideable_type, count(*) as number_of_rides
FROM summer_table
GROUP BY rideable_type
;

-- Total number of rides in summer based on day of week
...
-- Total number of rides in summer based on time of day
