...
-- Total number of rides based on membership in spring
SELECT member_casual, count(*) as number_of_rides
FROM spring_table
GROUP BY member_casual
;

-- Total number of rides based on rideable type in spring
SELECT rideable_type, count(*) as number_of_rides
FROM spring_table
GROUP BY rideable_type
;

-- Total number of rides in spring based on day of week
...
-- Total number of rides in spring based on time of day
