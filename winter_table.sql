...
-- ACCURACY
-- Confirm that values in the winter table fall between December 2020, and January and February 2021 
-- Between 1st december 2020 and 1st march 2021
select *
from winter_table
where started_at not between '2020-01-01' and '2021-03-01'
...
-- select * 
DELETE FROM winter_table
WHERE start_station_name like '%divvy%' or start_station_name like '%temp%' or start_station_name like '%test%' or start_station_name like '%check%' or 
	end_station_name like '%divvy%' or end_station_name like '%temp%' or end_station_name like '%test%' or end_station_name like '%check%' 
;
...
DELETE FROM winter_table
where start_station_id in ('631','E011', '13074','KA1504000168')
	or end_station_id in ('631','E011', '13074','KA1504000168')
;
